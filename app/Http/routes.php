...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'carteirinhas'], function () {
      ...
      Route::post('{id}', 'Admin\CarteirinhaController@updateCarteirinha');
      Route::get('gerarnumero', 'Admin\CarteirinhaController@gerarNumero');
    });
...
Route::group(['prefix' => 'associado'], function () {
    ...
    Route::group(['prefix' => 'carteirinha'], function () {
      ...
      Route::post('/2via', 'Associado\CarteirinhaController@segundaVia');
    });
});
