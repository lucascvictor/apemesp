...
{{ csrf_field() }}
		<fieldset>
			...
			<div class="form-group">
				<center>
					 <img src="{{ url('public/files/') }}/{{ $associado->cpf }}/{{$associado->foto }}" style = "width: 140px; height: 140px;" class = "img-circle" value="{{ $associado->foto }}">
		...
		<fieldset>
          ...
          <!-- Bairro -->
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input readonly="true" id="bairro" name="bairro" type="text" placeholder="Bairro" class="form-control input-md" required="" value="{{ $associado->bairro }}">
              </div>
            </div>
          ...
          <!-- Cidade  -->
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input readonly="true" id="cidade" name="cidade" type="text" placeholder="Cidade" class="form-control input-md" required="" value="{{ $cidade->nome }}">
              </div>
            </div>
            <input id="codCidade" name="codCidade" type="hidden" value="{{ $cidade->id }}"> </input>
