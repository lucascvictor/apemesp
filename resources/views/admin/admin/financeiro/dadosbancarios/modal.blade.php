               ...
               <fieldset>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <input onkeyup="somenteNumeros(this)"  id="documento" name="documento" type="text" placeholder="documento" class="form-control input-md" required="">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <input onkeyup="somenteNumeros(this)" id="agencia" name="agencia" type="text" placeholder="agencia" class="form-control input-md" required="">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <input onkeyup="somenteNumeros(this)" id="conta" name="conta" type="text" placeholder="conta" class="form-control input-md" required="">
                     </div>
                  </div>  
               </fieldset>
