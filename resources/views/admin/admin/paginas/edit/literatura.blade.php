...
<form method="POST"  enctype="multipart/form-data" action="{{ url('/admin/paginas/literatura/') }}/{{ $literatura[0]->id }}">
 {{ csrf_field() }}
  <fieldset>
...
<br />
    ...
    <div class="form-group">
      ...
      <img src="{{ url('/images/musicoterapia/literatura')}}/{{ $literatura[0]->imagem }}" style="width: 20%; heigth: 25%;">
      <hr>
    </div>
  ...
  <!-- Campo Titulo -->
    <div class="form-group">
      ...
      <div class="col-md-4">
      <input id="titulo" name="titulo" type="text" placeholder="Titulo da Obra ou do Site" class="form-control input-md" required="" value="{{ $literatura[0]->titulo }}">
      </div>
    </div>
    <br />
    <br />
  <!-- Campo Descrição -->
    <div class="form-group">
      ...
      <div class="col-md-6">
        ...
        {{ Form::textarea('conteudo', $literatura[0]->conteudo, array('class' => 'form-control input-md',
        'id' => 'conteudo',
        'name' => 'conteudo',
    ...
    <center class="col-md-1"><button type="submit" id="salvar" class="btn btn-success"> Salvar Literatura</button></center>
  </fieldset>
</form>
