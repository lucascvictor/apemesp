...
@foreach($linhadotempo as $item)
				<tr>
								...
								<td>
                  <img src="{{ url('/images/musicoterapia/material')}}//{{ $item->imagem }}" style="width: 30px; heigth: 25px;">
								</td>
								<td><b>{{ $item->titulo }}</b></td>
								<td><a class="btn btn-default" href="{{ url('/admin/paginas/material') }}/ {{ $item->id }}">Editar</a></td>
<td>
      ...
      <div class="modal-dialog">
        ...
        <!-- Modal content-->
            <div class="modal-content">
              <form class="form-horizontal" method="GET" action="{{ url('/admin/paginas/material/destroy')}}/{{ $item->id}}">
               {{ csrf_field() }}
...
@endforeach
<a class="btn btn-success" href="/admin/paginas/adicionar/linhadotempo">dicionar Material</a>
