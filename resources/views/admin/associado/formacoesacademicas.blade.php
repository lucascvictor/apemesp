						...
						<table class="table table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="btn btn-default" href="{{ url('/associado/formacao/edit/') }}/{{ $formacao->id }}">Editar</a>
									</td>
									<td>
										<a class="btn btn-primary" href="{{ url('/associado/formacao/') }}/{{ $formacao->id }}">Visualizar Formação</a>
									</td>
								</tr>
                                 @endforeach
